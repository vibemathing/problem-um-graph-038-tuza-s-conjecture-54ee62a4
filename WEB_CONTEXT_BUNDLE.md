...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-038-tuza-s-conjecture-54ee62a4-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-038"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-038-tuza-s-conjecture-54ee62a4-v1",
      "problem_contract_sha256": "33f53917081bb13abde6f0f77bcd8c2914fcc31a23328a6c27d0c1b877ec2839",
      "problem_id": "problem:um-graph-038-tuza-s-conjecture-54ee62a4",
      "route_id": "route:um-graph-038-tuza-s-conjecture-54ee62a4-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-038-tuza-s-conjecture-54ee62a4-source-fidelity-01",
      "graph_id": "graph:um-graph-038-tuza-s-conjecture-54ee62a4-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-038-tuza-s-conjecture-54ee62a4-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-038-tuza-s-conjecture-54ee62a4-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Can the edges of any graph be covered by at most 2ν triangles, where ν is the maximum size of a triangle packing?"
          },
          "statement_sha256": "28c3e1b8c619848854a94fd2a1677d9bd6238de658ef82ab9a7c60b452e3c88b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-038-tuza-s-conjecture-54ee62a4-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-038-tuza-s-conjecture-54ee62a4-root",
      "route_id": "route:um-graph-038-tuza-s-conjecture-54ee62a4-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-038-9993b8fd519b",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-038"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
